...
OPENLM_PRETRAINED_MODEL_ARCHIVE_LIST = None


class OpenLMForCausalLM(metaclass=DummyObject):
    _backends = ["torch"]
...
class OpenLMModel(metaclass=DummyObject):
    _backends = ["torch"]
...
class OpenLMPreTrainedModel(metaclass=DummyObject):
    _backends = ["torch"]
